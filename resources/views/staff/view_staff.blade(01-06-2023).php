    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="row">
                    <div class="col-sm-3">
                        <label for="dimensions">{{ __('Photo Id')}}</label>
                    </div>
                    <div class="col-sm-3">
                        <div style="display: {{ (isset($user_detail->photo_id) && !empty($user_detail->photo_id) ? 'block': 'none')}};">
                            <div class="form-group">
                                <?php
                                echo '<a href="javascript:" onclick=imageZoom(\'storage\',\'' . $user_detail->photo_id . '\')>';
                                ?>
                                <div class="copy_class">
                                    <img id="" src="{{ isset($user_detail->photo_id) && !empty($user_detail->photo_id) ? url('storage/'.$user_detail->photo_id) : '' }}" class="img-responsive">
                                </div>
                                </a>
                            </div>
                        </div>
