...
<html class="no-js" lang="en">
    <head>
        ...
        <title>{{ __('Reset Password | KEPTO FINTECH') }}</title>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-7 my-auto p-0">
                        <div class="authentication-form mx-auto reset-password">
                            <div class="logo-centered">
                                <a href=""><img style="max-width:100px"  src="{{ asset('company_logo/') }}/{{(isset($company_detail->company_logo) && !empty($company_detail->company_logo) ? $company_detail->company_logo:'')}}" alt=""></a>
                            </div>
